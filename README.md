...
💻 Frontend Engineer — Next.js (+ Backend, NestJS)  
🧩 유저의 기존 경험을 해치지 않는 선에서 사용성을 고민하며 기획부터 개발까지 이어갑니다  
🚀 기획·설계·개발·QA·배포 전 과정을 직접 책임지며, 사용자에게 닿는 제품을 만들어 왔습니다

---

## 💼 Career

**어치브모먼트**  ·  Frontend Engineer  ·  2025.01 ~ ING

AI 기반 B2B SaaS [Blaybus](https://www.blaybus.com/)의 웹 전반을 개발 (FE 중심 + 일부 BE)

- **AI 기반 업무 설계·협업 (PMS)** — Agenda·Work·Task 구조로 팀의 일을 설계하고 관리하는 협업 워크스페이스
- **참여형 프로그램 운영** — 공모전·대외활동·채용의 전 과정(모집·선발·제출·심사·수상·교육·멘토링)을 다루는 운영 기능
...
| 상명대학교 총학생회 | 제46대 총학생회 '선[先]' 공식 홈페이지 | [Sangmyung-front](https://github.com/sikkzz/Sangmyung-front) |
